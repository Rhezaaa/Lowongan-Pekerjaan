                            ...
                            <tr data-entry-id="{{ $job->id }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('admin.jobs.edit', $job->id) }}" class="btn btn-info">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <form onclick="return confirm('are you sure ? ')" class="d-inline" action="{{ route('admin.jobs.destroy', $job->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
