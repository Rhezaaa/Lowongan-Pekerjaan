...
<main>
      ...
      <div class="slider-area">
        <div
          ...
          data-background="{{ asset('joblisting/assets/img/hero/about.jpg') }}"
        >
          <div class="container">
            <div class="row">
              <div class="col-xl-12">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-6">
              <div class="support-location-img">
                <img src="{{ asset('joblisting/assets/img/service/support-img.jpg') }}" alt="" />
      ...
      <div
        ...
        data-background="{{ asset('joblisting/assets/img/gallery/how-applybg.png') }}"
      >
        <div class="container">
          <!-- Section Tittle -->
          <div class="row">
